...
<link href="<%=basepath %>/css/index_first.css"	rel="stylesheet">
<title>首页</title>
</head>
<body>
<body class="body-fixtop">
	<nav class="nav">
		<a href="#" class="nav-a">用户请登录</a> <a href="#" class="nav-a">主页</a> <a
	...
	<div>
		...
		<div>
			...
			<div class="hot-title">
				<a href="#" class="act">华硕Y481</a> <a href="#" class="act">IPad
					MiNi</a> <a href="#" class="act">华为荣耀4X</a>
			</div>
		</div>
					...
					<div id="carousel-example-generic" class="carousel slide standerd"
						...
						<div class="carousel-inner standerd" role="listbox">
							<div class="item active">
								<img src="../image/pic1.png" alt="..." class="standerd">
							</div>
							<div class="item">
								<img src="../image/pic2.png" alt="..." class="standerd">
							</div>
							<div class="item">
								<img src="../image/pic3.png" alt="..." class="standerd">
							</div>
						</div>
			...
			<div class="thir-col">
				<div class="message">
					<div class="user_info">
						...
						<div class="user_img_box">
							<div class="hello_text">hi,你好</div>
							<div class="user_do">
								<!--尚未定义a标签样式  -->
								<a class="login">登录</a> <a class="regist">注册</a>
							</div>
						</div>
				...
				<div class="panel panel-primary hot-news">
					...
					<div class="panel-body">本站建设中，暂无更多信息</div>
				</div>
